...
{
    public class Licence_PE_ISM_GeneralDetail
    {
        [Key]
        ...
        public virtual ICollection<Licence_PE_ISM_Contrator> Licence_PE_ISM_Contrators { get; set; }

    }


    public class Licence_PE_ISM_Contrator
    {
        [Key]
        public Int64 Id { get; set; }
        ...
        [Required(ErrorMessage = "Licence_PE_ISM_GeneralDetailId is required..!")]
        [ForeignKey("Licence_PE_ISM_GeneralDetail")]
        public Int64? Licence_PE_ISM_GeneralDetailId { get; set; }
        ...
        [NotMapped]
        public Int64 OldAppRefId { get; set; }
    ...
    public class Licence_PE_ISM_AmendmentDataHistories
    {
        [Key]
        public Int64 Id { get; set; }
